 ...
 * {@code a2ui_ask_user_question}. The tree-based entry point {@link #renderEnvelope} validates
 * against the catalog, resolves the surface, and serializes the single-layer envelope whose JSON
 * <em>is</em> the tool result text. {@link #renderFromIntent} is the intent-based front door used by
 * the render/present tools: the component tree is generated by the {@link A2uiRenderManager}
 * sub-agent call first, then goes through the same envelope pipeline.
 */
