 ...
 */
class FeishuAccessTokenProviderTest {
    ...
    private final FeishuAccessTokenProvider provider =
            new FeishuAccessTokenProvider(UNREACHABLE_API_BASE, "appId", "appSecret", store);
